...
## Description
Here our teams has created a bitcoin currency converter which takes the current bitcoin in usd and converts it to bitcoin / selcted currency([Visit the website here.](https://devontehillman.github.io/Horiseon-Marketing-Specialist-hw-/)) without changing it's functionality. This refactoring inculdes accessible features for assistive technologies to increase search engine optimization. In order to achive this I have:
